...
@overload
def validate_array(arr: npt.NDArray[np.bool_] | np.bool_ | bool | _NestedBool | Sequence[npt.NDArray[np.bool_]] | Sequence[Sequence[npt.NDArray[np.bool_]]], /, *, dtype_out: None = None, must_be_real: Literal[False], to_list: Literal[True], to_tuple: Literal[False] = False, **kwargs: Unpack[_ArrayKwargs]) -> _ToListBool: ...
@overload
...
@overload
def validate_array(arr: npt.NDArray[_Floating] | _Floating | float | _NestedFloat | Sequence[npt.NDArray[_Floating]] | Sequence[Sequence[npt.NDArray[_Floating]]], /, *, dtype_out: None = None, must_be_real: bool = ..., to_list: Literal[True], to_tuple: Literal[False] = False, **kwargs: Unpack[_ArrayKwargs]) -> _ToListFloat: ...
@overload
...
@overload
def validate_array(arr: npt.NDArray[np.bool_] | np.bool_ | bool | _NestedBool | Sequence[npt.NDArray[np.bool_]] | Sequence[Sequence[npt.NDArray[np.bool_]]], /, *, dtype_out: None = None, must_be_real: Literal[False], to_list: bool = False, to_tuple: Literal[True], **kwargs: Unpack[_ArrayKwargs]) -> _ToTupleBool: ...
@overload
...
@overload
def validate_array(arr: npt.NDArray[_Floating] | _Floating | float | _NestedFloat | Sequence[npt.NDArray[_Floating]] | Sequence[Sequence[npt.NDArray[_Floating]]], /, *, dtype_out: None = None, must_be_real: bool = ..., to_list: bool = False, to_tuple: Literal[True], **kwargs: Unpack[_ArrayKwargs]) -> _ToTupleFloat: ...
@overload
